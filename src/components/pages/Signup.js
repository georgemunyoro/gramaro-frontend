...
export default () => {
  ...
  return (
	<div className="signup-container">
	  ...
	  <form>
		<Input onChange={(e) => setEmail(e.target.value)} name="email" type="email" placeholder="peter.gregory@hooli.com"  className="input"/>
		<Input onChange={(e) => setUsername(e.target.value)} name="username" type="text" placeholder="name" className="input"/>
